...
import { t as Gavel } from "../../../../chunks/gavel.js";
import { t as Scale } from "../../../../chunks/scale.js";
...
//#region src/routes/[lang]/terms/+page.svelte
		...
		const sections = derived(() => {
			...
			return sanitySections.map((section, index) => {
				...
				return {
					id: key,
					title: section.title,
					icon: iconMap[config.icon] || File_text,
					color: config.color,
