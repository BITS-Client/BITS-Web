...
//#region src/routes/[lang]/+error.svelte
function _error($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		head("12gmg1u", $$renderer, ($$renderer) => {
			$$renderer.title(($$renderer) => {
				$$renderer.push(`<title>${escape_html(errorInfo().title)} | BITS</title>`);
			});
		});
		$$renderer.push(`<div class="error-page svelte-12gmg1u"${attr_style("", { transform: `translate(${stringify(mouseX)}px, ${stringify(mouseY)}px)` })}><div class="error-bg svelte-12gmg1u"><div class="gradient-orb orb-1 svelte-12gmg1u"></div> <div class="gradient-orb orb-2 svelte-12gmg1u"></div> <div class="gradient-orb orb-3 svelte-12gmg1u"></div> <div class="grid-overlay svelte-12gmg1u"></div></div> <div class="floating-elements svelte-12gmg1u"><!--[-->`);
		const each_array = ensure_array_like(Array(12));
		for (let i = 0, $$length = each_array.length; i < $$length; i++) {
			each_array[i];
			$$renderer.push(`<div class="floating-shape svelte-12gmg1u"${attr_style(` left: ${stringify(Math.random() * 100)}%; animation-delay: ${stringify(i * .5)}s; animation-duration: ${stringify(15 + Math.random() * 10)}s; `)}></div>`);
		}
		$$renderer.push(`<!--]--></div> <div class="error-content svelte-12gmg1u">`);
		$$renderer.push("<!--[-1-->");
