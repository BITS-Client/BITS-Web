...
export const seoConfig = {
	...
	siteUrl: env.PUBLIC_SITE_URL || 'https://bits.co.id',
	contactEmail: env.PUBLIC_CONTACT_EMAIL || 'admin@bits.co.id',
	...
	locale: 'id_ID',
	phoneDisplay: env.PUBLIC_PHONE_DISPLAY || '+62 819 678 048',
	whatsappNumber: env.PUBLIC_WHATSAPP_NUMBER || '62819678048',
	themeColor: '#ff3e00',
	sitemapPriority: 0.5,
