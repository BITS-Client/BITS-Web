...
1. Create in appropriate category folder: `web/src/lib/components/ui/{category}/`
...
```svelte
<!-- web/src/lib/components/ui/card/FeatureCard.svelte -->
<script lang="ts">
...
rg -n "interface Props" web/src/lib/components/ui/

# Find component usage
rg -n "import.*from.*components/ui" web/src/routes/

# Find all cards
ls web/src/lib/components/ui/card/

# Find animation components
ls web/src/lib/components/ui/animation/
```
